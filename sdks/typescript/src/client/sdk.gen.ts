 ...
 */
export const getCollectionMetadataCollectionsDatasetsGet = <ThrowOnError extends boolean = false>(options?: Options<GetCollectionMetadataCollectionsDatasetsGetData, ThrowOnError>): RequestResult<GetCollectionMetadataCollectionsDatasetsGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetCollectionMetadataCollectionsDatasetsGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getRecordSchemaCollectionsDatasetsSchemaGet = <ThrowOnError extends boolean = false>(options?: Options<GetRecordSchemaCollectionsDatasetsSchemaGetData, ThrowOnError>): RequestResult<GetRecordSchemaCollectionsDatasetsSchemaGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetRecordSchemaCollectionsDatasetsSchemaGetResponses, unknown, ThrowOnError>({ url: '/collections/datasets/schema', ...options });
 ...
 */
export const landingPageStacGet = <ThrowOnError extends boolean = false>(options?: Options<LandingPageStacGetData, ThrowOnError>): RequestResult<LandingPageStacGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<LandingPageStacGetResponses, unknown, ThrowOnError>({ url: '/stac/', ...options });
 ...
 */
export const getCollectionsStacCollectionsGet = <ThrowOnError extends boolean = false>(options?: Options<GetCollectionsStacCollectionsGetData, ThrowOnError>): RequestResult<GetCollectionsStacCollectionsGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetCollectionsStacCollectionsGetResponses, unknown, ThrowOnError>({ url: '/stac/collections', ...options });
 ...
 */
export const conformanceStacConformanceGet = <ThrowOnError extends boolean = false>(options?: Options<ConformanceStacConformanceGetData, ThrowOnError>): RequestResult<ConformanceStacConformanceGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ConformanceStacConformanceGetResponses, unknown, ThrowOnError>({ url: '/stac/conformance', ...options });
