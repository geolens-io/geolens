 ...
 */
export const getCollectionItemsStacCollectionsCollectionIdItemsGet = <ThrowOnError extends boolean = false>(options: Options<GetCollectionItemsStacCollectionsCollectionIdItemsGetData, ThrowOnError>) => (options.client ?? client).get<GetCollectionItemsStacCollectionsCollectionIdItemsGetResponses, GetCollectionItemsStacCollectionsCollectionIdItemsGetErrors, ThrowOnError>({ url: '/stac/collections/{collection_id}/items', ...options });
 ...
 */
export const getItemStacItemsItemIdGet = <ThrowOnError extends boolean = false>(options: Options<GetItemStacItemsItemIdGetData, ThrowOnError>) => (options.client ?? client).get<GetItemStacItemsItemIdGetResponses, GetItemStacItemsItemIdGetErrors, ThrowOnError>({ url: '/stac/items/{item_id}', ...options });
 ...
 */
export const searchGetStacSearchGet = <ThrowOnError extends boolean = false>(options?: Options<SearchGetStacSearchGetData, ThrowOnError>) => (options?.client ?? client).get<SearchGetStacSearchGetResponses, SearchGetStacSearchGetErrors, ThrowOnError>({ url: '/stac/search', ...options });
