...
from ...models.o_auth_provider_update import OAuthProviderUpdate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = OAuthProviderResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        provider_id (UUID):
        body (OAuthProviderUpdate): Schema for updating an existing OAuth provider. All fields
            optional.
