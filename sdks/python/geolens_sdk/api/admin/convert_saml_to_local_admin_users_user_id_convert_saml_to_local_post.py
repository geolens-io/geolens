...
from ...models.saml_to_local_conversion import SamlToLocalConversion
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/users/{user_id}/convert-saml-to-local/".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (UUID):
        body (SamlToLocalConversion): Request body for POST /admin/users/{user_id}/convert-saml-
            to-local/.
