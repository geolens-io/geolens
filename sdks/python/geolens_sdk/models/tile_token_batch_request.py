...
T = TypeVar("T", bound="TileTokenBatchRequest")


@_attrs_define
class TileTokenBatchRequest:
    """Batch request for tile tokens — accepts up to 50 dataset IDs.

    Attributes:
        dataset_ids (list[UUID]): Dataset IDs to generate tokens for. Must be unique; duplicates deduplicated server-
            side.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tile_token_batch_request = cls(
            dataset_ids=dataset_ids,
        )

        tile_token_batch_request.additional_properties = d
        return tile_token_batch_request
