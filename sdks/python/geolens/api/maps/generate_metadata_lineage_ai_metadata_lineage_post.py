...
from ...models.lineage_draft_response import LineageDraftResponse
...
) -> LineageDraftResponse | ProblemDetail | None:
    if response.status_code == 200:
        response_200 = LineageDraftResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[LineageDraftResponse | ProblemDetail]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        LineageDraftResponse | ProblemDetail
    """
