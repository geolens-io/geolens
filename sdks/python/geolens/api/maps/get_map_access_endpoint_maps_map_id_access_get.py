...
from ...models.map_access_response import MapAccessResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MapAccessResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        MapAccessResponse | ProblemDetail
    """
