...
from ...models.embed_token_update import EmbedTokenUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/maps/{map_id}/embed-tokens/{token_id}/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EmbedTokenResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        EmbedTokenResponse | ProblemDetail
    """
