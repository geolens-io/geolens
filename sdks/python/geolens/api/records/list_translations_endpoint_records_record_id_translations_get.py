...
from ...models.translation_list_response import TranslationListResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/records/{record_id}/translations/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TranslationListResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        ProblemDetail | TranslationListResponse
    """
