...
from ...models.bulk_register_response import BulkRegisterResponse
...
) -> BulkRegisterResponse | ProblemDetail | None:
    if response.status_code == 201:
        response_201 = BulkRegisterResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BulkRegisterResponse | ProblemDetail]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        BulkRegisterResponse | ProblemDetail
    """
