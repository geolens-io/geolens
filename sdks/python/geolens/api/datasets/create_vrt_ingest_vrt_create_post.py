...
from ...models.vrt_create_request import VrtCreateRequest
from ...models.vrt_create_response import VrtCreateResponse
...
) -> ProblemDetail | VrtCreateResponse | None:
    if response.status_code == 202:
        response_202 = VrtCreateResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ProblemDetail | VrtCreateResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ProblemDetail | VrtCreateResponse
    """
