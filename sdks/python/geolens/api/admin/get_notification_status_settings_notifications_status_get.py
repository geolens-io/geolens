...
from ...models.notification_status_response import NotificationStatusResponse
...
) -> NotificationStatusResponse | ProblemDetail | None:
    if response.status_code == 200:
        response_200 = NotificationStatusResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[NotificationStatusResponse | ProblemDetail]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        NotificationStatusResponse | ProblemDetail
    """
