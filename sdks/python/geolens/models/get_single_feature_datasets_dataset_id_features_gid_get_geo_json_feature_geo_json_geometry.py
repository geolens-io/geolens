...
from ..models.get_single_feature_datasets_dataset_id_features_gid_get_geo_json_feature_geo_json_geometry_type import (
    check_get_single_feature_datasets_dataset_id_features_gid_get_geo_json_feature_geo_json_geometry_type,
)
from ..models.get_single_feature_datasets_dataset_id_features_gid_get_geo_json_feature_geo_json_geometry_type import (
...
T = TypeVar(
    "T",
    bound="GetSingleFeatureDatasetsDatasetIdFeaturesGidGetGeoJSONFeatureGeoJSONGeometry",
)


@_attrs_define
class GetSingleFeatureDatasetsDatasetIdFeaturesGidGetGeoJSONFeatureGeoJSONGeometry:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return get_single_feature_datasets_dataset_id_features_gid_get_geo_json_feature_geo_json_geometry
