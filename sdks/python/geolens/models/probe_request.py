...
class ProbeRequest:
    """
    Attributes:
        url (str): Service URL to probe. May be a WFS GetCapabilities URL or an ArcGIS service endpoint.
        token (None | str | Unset): Optional auth token for protected services (passed as query parameter or bearer
            token depending on service type). Deprecated: use the auth object with method bearer.
