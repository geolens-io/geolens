...
**Delivered:**
- Verified Dependabot `urllib3` alerts against `backend/pyproject.toml`, `backend/uv.lock`, `uv lock`, and `pip-audit`; local state is scanner-clean at `urllib3==2.7.0`.
