...
grep -q "user.convert_saml_to_local" docs/edition-deactivation.md # D-14 audit action name
...
grep -q '"user.convert_saml_to_local"' backend/app/modules/admin/router.py
...
**Approval:** executed and verified
