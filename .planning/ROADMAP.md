...
Plans:
**Wave 1**
- [ ] 227-01-PLAN.md — restore-and-parameterize-generator: revert 5 dirty SAML fixtures to HEAD baseline (D-09); add `output_dir: Path | None = None` parameter to `generate_fixtures.main()` (D-05). Manual CLI invocation preserved. Test suite stays green; in-place autouse path unchanged. (Wave 1, TESTFIX-01)
