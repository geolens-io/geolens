...
export function CollectionDetailPanel(props: DetailPanelProps) {
  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange}>
      <TabsList className="overflow-x-auto w-full sticky top-0 z-10 bg-background border-b">
        ...
        <TabsTrigger value="members">{t('tabs.members', { defaultValue: 'Members' })}</TabsTrigger>
      ...
      <TabsContent value="members" className="space-y-6">
        <div className="text-sm text-muted-foreground">
          {t('collection.membersPlaceholder', { defaultValue: 'Collection member listing coming soon.' })}
        </div>
      </TabsContent>
