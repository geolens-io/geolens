...
if (!getWidgets().find((w) => w.id === WIDGET_A_ID)) {
  registerWidget({ id: WIDGET_A_ID, label: 'Widget A', icon: LayoutGrid, slot: 'top-left', component: WidgetA });
  registerWidget({ id: WIDGET_B_ID, label: 'Widget B', icon: LayoutGrid, slot: 'top-right', component: WidgetB });
  registerWidget({ id: WIDGET_CRASH_ID, label: 'Crash', icon: LayoutGrid, slot: 'bottom-left', component: CrashingWidget });
}
