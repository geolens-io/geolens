...
import { useCreateCollection } from '@/components/collections/hooks/use-collections';
...
export function CollectionCreateDialog({ open, onOpenChange }: CollectionCreateDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Wait for active collection queries to refresh before closing the dialog.
      // The predicate includes parameterized collection query keys.
