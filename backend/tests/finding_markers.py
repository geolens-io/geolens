...
# reporting zero findings and passing (#1552). Measured 429 modules and 9593
# units on the commit that introduced this file.
MIN_SCANNED_MODULES = 350
MIN_SCANNED_UNITS = 7000

# The unanchored markers already on main, frozen per module and EXACT in both
# directions: a new marker fails, and so does removing one without lowering
# the number. The gate refuses NEW debt; these numbers only go down.
UNANCHORED_MARKER_DEBT: dict[str, int] = {
    ...
    "modules/catalog/datasets/api/router_export.py": 11,
    ...
    "modules/catalog/datasets/api/router_reupload.py": 10,
    ...
    "modules/catalog/maps/router.py": 8,
    "modules/catalog/maps/router_assets.py": 1,
    "modules/catalog/maps/router_sharing.py": 3,
    "modules/catalog/maps/schemas.py": 13,
    "modules/catalog/maps/service_crud.py": 3,
    "modules/catalog/maps/service_diff.py": 2,
    "modules/catalog/maps/service_public.py": 11,
    "modules/catalog/maps/service_shared.py": 1,
    "modules/catalog/maps/sprites.py": 2,
    "modules/catalog/maps/style_json.py": 5,
    "modules/catalog/search/cache.py": 1,
    ...
    "modules/catalog/sources/adapters/ogcapi.py": 4,
    "modules/catalog/sources/adapters/stac.py": 4,
    "modules/catalog/sources/adapters/wfs.py": 3,
    "modules/catalog/sources/classify.py": 6,
    "modules/catalog/sources/cog_info.py": 1,
    "modules/catalog/sources/origin_probe.py": 3,
    "modules/catalog/sources/preview.py": 1,
    "modules/catalog/sources/probe.py": 8,
    ...
    "platform/config_ops/router.py": 4,
    "platform/config_ops/service.py": 1,
    "platform/dataset_origin.py": 4,
    "platform/extensions/__init__.py": 32,
    "platform/extensions/bootstrap.py": 20,
    "platform/extensions/defaults_ai_anthropic.py": 3,
    "platform/extensions/defaults_ai_openai.py": 9,
    "platform/extensions/defaults_catalog_port.py": 1,
    "platform/extensions/defaults_extensions.py": 9,
    "platform/extensions/defaults_processing_port.py": 7,
    "platform/extensions/entitlement.py": 3,
    "platform/extensions/protocols.py": 22,
    "platform/extensions/version.py": 3,
    "platform/jobs/defer_guard.py": 1,
    "platform/jobs/heartbeat.py": 1,
    "platform/jobs/models.py": 3,
    "platform/jobs/router.py": 5,
    "platform/jobs/schemas.py": 4,
    "platform/jobs/sweep.py": 1,
    "platform/jobs/worker.py": 5,
    "platform/notifications/__init__.py": 5,
    "platform/notifications/env_sink.py": 5,
    "platform/notifications/events.py": 8,
    ...
    "platform/storage/local.py": 4,
    "platform/storage/provider.py": 6,
    "platform/storage/titiler_url.py": 7,
    ...
    "processing/ai/llm_loop.py": 8,
    "processing/ai/metadata_service.py": 1,
    "processing/ai/probe.py": 1,
    "processing/ai/router.py": 2,
    "processing/ai/service.py": 1,
    "processing/ai/sql_generator.py": 4,
    ...
    "processing/ingest/metadata_projection.py": 4,
    "processing/ingest/metadata_sql.py": 1,
    "processing/ingest/ogr.py": 17,
    ...
    "processing/ingest/tasks_common.py": 40,
    "processing/ingest/tasks_postgis_refresh.py": 2,
    "processing/ingest/tasks_raster.py": 29,
    "processing/ingest/tasks_raster_common.py": 5,
    "processing/ingest/tasks_raster_replace.py": 3,
    "processing/ingest/tasks_reupload.py": 7,
    "processing/ingest/tasks_stac_refresh.py": 4,
    "processing/ingest/tasks_vector.py": 27,
    ...
    "processing/tiles/pool.py": 5,
    "processing/tiles/router.py": 25,
    "processing/tiles/service.py": 15,
    "processing/tiles/signing.py": 4,
    "processing/vector/quicklook.py": 2,
    "standards/ogc/errors.py": 2,
    "standards/ogc/router.py": 16,
    "standards/stac/router.py": 10,
}
