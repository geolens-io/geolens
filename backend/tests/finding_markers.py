...
UNANCHORED_MARKER_DEBT: dict[str, int] = {
    ...
    "modules/catalog/datasets/domain/schemas.py": 3,
    ...
    "processing/ingest/router.py": 11,
    "processing/ingest/schemas.py": 1,
    "processing/ingest/tasks_common.py": 36,
