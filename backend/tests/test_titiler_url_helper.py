...
def test_tiles_router_uses_helper():
    ...
    # Strip comments before checking for literal Titiler hosts: the SEC-OBSV-01
    # comment (#1927) names "Titiler" in prose but never the literal
    # "http://titiler:8000" host string.
    non_comment_lines = [
