...
class TestLoadExtensions:
    def test_load_extensions_empty(self):
        ...
        from app.extensions import _loaded as loaded_after
    ...
    def test_load_extensions_handles_failure(self, caplog):
        ...
        with patch("app.extensions.entry_points", return_value=[bad_ep, good_ep]):
            load_extensions()
...
class TestRegistryHelpers:
    def test_get_extension_missing(self):
        ...
        from app.extensions import get_extension, load_extensions
    ...
    def test_has_extension(self):
        ...
        from app.extensions import _extensions, has_extension, load_extensions
    ...
    def test_list_extensions(self):
        ...
        from app.extensions import _extensions, list_extensions, load_extensions
...
class TestProtocolDefaults:
    def test_protocol_defaults(self):
        ...
        from app.extensions.defaults import (
            DefaultAuditExtension,
            DefaultAuthExtension,
            DefaultBrandingExtension,
        )
        from app.extensions.protocols import (
            AuditExtension,
            AuthExtension,
            BrandingExtension,
        )
    ...
    def test_branding_default_shows_badge(self):
        ...
        from app.extensions.defaults import DefaultBrandingExtension
    ...
    def test_auth_default_methods(self):
        ...
        from app.extensions.defaults import DefaultAuthExtension
    ...
    def test_audit_default_formats(self):
        ...
        from app.extensions.defaults import DefaultAuditExtension
